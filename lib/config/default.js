...
defaultConfig.definition = () => ({
  ...
  security: {
     ...
     */
    mode: {
      formatter: allowList.bind(null, ['IAST', 'RASP', 'IAST_RESTRICTED', 'IAST_MONITORING']),
      default: 'IAST'
    },
    ...
    /**
     * Provide a test identifier when runnning IAST with CI/CD
     */
    ...
    scan_controllers: {
      ...
      /**
       * values are 1 or 0, 0 signifies run on all application instances
       */
      scan_instance_count: {
        formatter: int,
        default: 0
